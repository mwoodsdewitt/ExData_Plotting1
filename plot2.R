...
#creating the chart for plot 2
plot(household_power_consumption$Global_active_power ~ household_power_consumption$Date_Time, type="l", xlab="", ylab="Global Active Power (kilowatts)")